...
(function (preact, hooks, signals, i18next, dayjs, Dexie, dexieExportImport, fileSaverEs, tableCore) {
        ...
        render() {
            if (this.state.error) {
                return /* @__PURE__ */ u("div", {
                    class: "alert alert-error p-2", children: [
    ...
    function ExtensionPanel({
        ...
        return /* @__PURE__ */ u("section", {
            class: "module-panel", children: [
        /* @__PURE__ */ u("div", {
                class: "h-12 flex items-center justify-start", children: [
            /* @__PURE__ */ u("div", {
                    class: "relative flex h-4 w-4 mr-3 shrink-0", children: [
                        active && /* @__PURE__ */ u(
                            "span",
                            {
                                class: cx(
            ...
            /* @__PURE__ */ u("div", {
                    class: "flex flex-col flex-grow", children: [
    ...
    function Modal({ show, onClose, title, children, class: className }) {
        ...
        return /* @__PURE__ */ u("dialog", {
            class: "modal modal-open", open: true, children: [
        /* @__PURE__ */ u("div", {
                class: cx("modal-box p-3 flex flex-col", className), children: [
            /* @__PURE__ */ u("header", {
                    class: "flex items-center h-9 mb-2", children: [
            /* @__PURE__ */ u(
                        "div",
                        {
                            onClick: onClose,
    ...
    function SearchArea({ defaultValue, onChange }) {
        ...
        return /* @__PURE__ */ u("div", {
            class: "join justify-end my-[2px] w-full max-w-[50%] absolute top-3 right-3", children: [
        /* @__PURE__ */ u(
                "input",
                {
                    ref: inputRef,
        ...
        /* @__PURE__ */ u("button", {
                class: "btn btn-sm join-item", onClick: () => {
                    var _a;
    ...
    function MultiSelect(props) {
        ...
        return /* @__PURE__ */ u("div", {
            class: cx("dropdown", props.class), children: [
        /* @__PURE__ */ u(
                "div",
                {
                    tabIndex: 0,
        ...
        /* @__PURE__ */ u(
                "ul",
                {
                    ...
                    children: options2.map((option) => /* @__PURE__ */ u("li", {
                        children: /* @__PURE__ */ u("label", {
                            class: "label cursor-pointer justify-start", children: [
                /* @__PURE__ */ u(
                                "input",
                                {
                                    type: "checkbox",
    ...
    function MediaDisplayColumn({ data, onClick }) {
        return /* @__PURE__ */ u("div", {
            class: "flex flex-row items-start space-x-1 w-max", children: [
                data.map((media) => {
                    var _a;
                    return /* @__PURE__ */ u(
                        "div",
        ...
        try {
            ...
            switch (format) {
                ...
                case EXPORT_FORMAT.CSV:
                    ...
                    break;
                case EXPORT_FORMAT.MD_TREE:
                    content = await mdTreeExporter(data);
                    try {
                        await navigator.clipboard.writeText(content);
                        logger.info("Markdown tree copied to clipboard");
                    } catch (clipErr) {
                        logger.warn("Clipboard write failed, falling back to file download");
                        saveFile(filename.replace(/\.md_tree$/, ".md"), content);
                    }
                    return;
            }
    ...
    async function mdTreeExporter(data) {
        const tweetMap = {};
        const childrenMap = {};
        for (const tweet of data) {
            tweetMap[tweet.id] = tweet;
            childrenMap[tweet.id] = [];
        }
        const roots = [];
        const orphans = [];
        for (const tweet of data) {
            const parentId = tweet.in_reply_to;
            if (!parentId) {
                roots.push(tweet);
            } else if (tweetMap[parentId]) {
                childrenMap[parentId].push(tweet);
            } else {
                orphans.push(tweet);
            }
        }
        for (const id in childrenMap) {
            childrenMap[id].sort((a, b) => (a.created_at || "").localeCompare(b.created_at || ""));
        }
        const shortId = (id) => id ? id.slice(-4) : "?";
        function getBreadcrumb(tweet) {
            const chain = [];
            let cur = tweet;
            while (cur) {
                chain.unshift(`@${cur.screen_name}#${shortId(cur.id)}`);
                cur = cur.in_reply_to ? tweetMap[cur.in_reply_to] : null;
            }
            return chain.join(" > ");
        }
        function renderRootMeta(tweet) {
            const date = (tweet.created_at || "").replace(/ \+\d+:\d+$/, "");
            const lines = [
                `## Thread by @${tweet.screen_name}`,
                `> **Root ID:** ${tweet.id} | **Author:** @${tweet.screen_name} (${tweet.name || ""})`,
                `> **Posted:** ${date} | **Likes:** ${tweet.favorite_count || 0} | **Retweets:** ${tweet.retweet_count || 0} | **Replies:** ${tweet.reply_count || 0} | **Views:** ${tweet.views_count || 0}`,
                tweet.url ? `> **URL:** ${tweet.url}` : null,
                ""
            ];
        ...
        function renderTweet(tweet, depth) {
            ...
            const date = (tweet.created_at || "").split(" ")[0];
            const textLines = (tweet.full_text || "").split("\n").map((l) => `${indent}  ${l}`).join("\n");
            let header;
            if (depth === 0) {
                header = `${indent}- **@${tweet.screen_name}** · ${date} · ${likes} likes`;
            } else {
                header = `${indent}- **@${tweet.screen_name}** · ${date} · ${likes} likes`;
                header += `\n${indent}  \`${getBreadcrumb(tweet)}\``;
            }
            let result = header + "\n" + textLines + "\n";
            const children = childrenMap[tweet.id] || [];
            for (const child of children) {
                result += "\n" + renderTweet(child, depth + 1);
            }
            return result;
        }
        let output = "# Twitter Thread Tree\n";
        output += "This is a Twitter/X conversation exported as a nested reply tree. Each reply shows a breadcrumb trail (`@user#id_suffix > ...`) tracing the reply chain back to the root. Indentation reflects reply depth.\n\n---\n\n";
        for (const root of roots) {
            output += renderRootMeta(root) + "\n";
            output += renderTweet(root, 0) + "\n";
        }
        if (orphans.length > 0) {
            output += "## Orphan Replies (parent tweet not in dataset)\n\n";
            for (const orphan of orphans) {
                output += renderTweet(orphan, 0) + "\n";
            }
        }
        return output.trim();
    }
    ...
    function Settings() {
        ...
        return /* @__PURE__ */ u(preact.Fragment, {
            children: [
        /* @__PURE__ */ u(
                "div",
                {
        ...
        /* @__PURE__ */ u(Modal, {
                title: t("Settings"), show: showSettings, onClose: toggleSettings, class: "max-w-lg", children: [
            /* @__PURE__ */ u("p", { class: styles.subtitle, children: t("General") }),
            /* @__PURE__ */ u("div", {
                    class: cx(styles.block, "flex-col"), children: [
            /* @__PURE__ */ u("label", {
                        class: styles.item, children: [
            ...
            /* @__PURE__ */ u("label", {
                        class: styles.item, children: [
                /* @__PURE__ */ u("div", {
                            class: "flex items-center", children: [
            ...
            /* @__PURE__ */ u("div", {
                    class: cx(styles.block, "flex-col", "max-h-44 overflow-scroll"), children: extensionManager.getExtensions().map((extension) => /* @__PURE__ */ u("label", {
                        class: cx(styles.item, "flex-shrink-0"), children: [
            /* @__PURE__ */ u("span", {
                            children: [
            ...
            /* @__PURE__ */ u("div", {
                    class: styles.block, children: [
            /* @__PURE__ */ u("span", {
                        class: "label-text whitespace-nowrap", children: [
                            t("Version"),
                            " ",
                            packageJson.version
                        ]
            ...
            /* @__PURE__ */ u("a", {
                        class: "btn btn-xs btn-ghost", target: "_blank", href: packageJson.homepage, children: [
    ...
    function App() {
        ...
        /* @__PURE__ */ u(
                "section",
                {
                    ...
                    children: [
                /* @__PURE__ */ u("header", {
                        class: "flex items-center h-9", children: [
    ...
    out=${media.filename}` : media.url).join("\n");
        ...
        return /* @__PURE__ */ u(
            Modal,
            {
                ...
                children: [
            /* @__PURE__ */ u("div", {
                    class: "px-4 text-base overflow-y-scroll overscroll-none", children: [
                /* @__PURE__ */ u("p", {
                        class: "text-base-content text-opacity-60 leading-5 text-sm", children: t(
                ...
                /* @__PURE__ */ u("div", {
                        role: "alert", class: "alert text-sm py-2 mt-2 mb-2 grid-cols-[auto_minmax(auto,1fr)]", children: [
                ...
                /* @__PURE__ */ u("span", {
                        ...
                        isTweet && /* @__PURE__ */ u("div", {
                            class: "flex flex-wrap sm:grid grid-cols-4 sm:gap-2 items-center sm:h-9", children: [
                ...
                /* @__PURE__ */ u("div", {
                                class: "col-span-1 flex items-center", children: [
                    /* @__PURE__ */ u(
                                    "input",
                                    {
                                        type: "checkbox",
                ...
                /* @__PURE__ */ u("div", {
                            class: "my-3 overflow-x-scroll", children: [
                /* @__PURE__ */ u("table", {
                                class: "table table-xs table-zebra", children: [
                    /* @__PURE__ */ u("thead", {
                    ...
                    /* @__PURE__ */ u("tbody", {
                                    children: mediaList.map((media, index) => /* @__PURE__ */ u("tr", {
                                        children: [
                ...
                /* @__PURE__ */ u("div", {
                            class: "flex flex-col mt-6", children: [
                /* @__PURE__ */ u(
                                "progress",
                                {
            ...
            /* @__PURE__ */ u("div", {
                    class: "flex space-x-2 mt-2", children: [
                ...
                /* @__PURE__ */ u("button", {
                        class: cx("btn btn-secondary", loading && "btn-disabled"), onClick: onExport, children: [
    ...
    const Pagination = ({ table }) => {
        ...
        return /* @__PURE__ */ u("div", {
            className: "mt-3 flex items-center gap-2 flex-wrap", children: [
    ...
    function ExportDataModal({ title, table, show, onClose }) {
        ...
        return /* @__PURE__ */ u(
            Modal,
            {
                ...
                children: [
            /* @__PURE__ */ u("div", {
                    class: "px-4 text-base", children: [
                /* @__PURE__ */ u("p", {
                        class: "text-base-content text-opacity-60 mb-2 leading-5 text-sm", children: t(
            ...
            /* @__PURE__ */ u("div", {
                    class: "flex space-x-2", children: [
                /* @__PURE__ */ u("span", { class: "flex-grow" }),
                /* @__PURE__ */ u("button", { class: "btn", onClick: onClose, children: t("Cancel") }),
                /* @__PURE__ */ u("button", {
                        class: cx("btn btn-primary", loading && "btn-disabled"), onClick: onExport, children: [
                            loading && /* @__PURE__ */ u("span", { class: "loading loading-spinner" }),
                            selectedFormat === EXPORT_FORMAT.MD_TREE ? t("Copy to Clipboard") : t("Start Export")
                        ]
                    })
                    ]
                })
    ...
    function BaseTableView({
        ...
        /* @__PURE__ */ u("main", {
                class: "max-w-full grow overflow-scroll bg-base-200 overscroll-none", children: [
            /* @__PURE__ */ u("table", {
                    class: "table table-pin-rows table-border-bc table-padding-sm", children: [
            /* @__PURE__ */ u("thead", {
                        children: table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ u("tr", {
                            children: headerGroup.headers.map((header) => /* @__PURE__ */ u(
                                "th",
                                {
        ...
        /* @__PURE__ */ u("div", {
                class: "flex mt-3 space-x-2", children: [
    ...
    const columns$2 = [
        ...
        columnHelper$2.accessor("core.user_results.result.core.screen_name", {
            ...
            cell: (info) => /* @__PURE__ */ u("p", {
                class: "whitespace-pre", children: /* @__PURE__ */ u(
                    "a",
                    {
                        class: "link",
                        target: "_blank",
        ...
        columnHelper$2.accessor("legacy.in_reply_to_screen_name", {
            ...
            cell: (info) => /* @__PURE__ */ u("p", {
                class: "whitespace-pre", children: info.row.original.legacy.in_reply_to_status_id_str ? /* @__PURE__ */ u("a", {
                    class: "link", target: "_blank", href: getInReplyToTweetURL(info.row.original), children: [
                        "@",
                        info.getValue()
                    ]
                }) : "N/A"
        ...
        columnHelper$2.accessor(rtSourceAccessor, {
            ...
            cell: (info) => {
                ...
                return /* @__PURE__ */ u("p", {
                    class: "whitespace-pre", children: source ? /* @__PURE__ */ u("a", {
                        class: "link", target: "_blank", href: getTweetURL(source), children: [
                            "@",
                            info.getValue()
                        ]
                    }) : "N/A"
        ...
        columnHelper$2.display({
            ...
            cell: (info) => /* @__PURE__ */ u("p", {
                children: extractTweetMediaTags(info.row.original).length ? extractTweetMediaTags(info.row.original).map((tag) => /* @__PURE__ */ u("a", {
                    class: "link inline-block", target: "_blank", href: getUserURL(tag.screen_name), children: [
                        "@",
                        tag.screen_name
                    ]
                })) : "N/A"
        ...
        columnHelper$2.display({
            ...
            cell: (info) => /* @__PURE__ */ u("div", {
                class: "flex flex-row items-start space-x-1", children: /* @__PURE__ */ u(
                    "button",
                    {
                        onClick: () => {
                            var _a;
    ...
    const columns$1 = [
        ...
        columnHelper$1.accessor("core.screen_name", {
            ...
            header: () => /* @__PURE__ */ u(Trans, { i18nKey: "Screen Name" }),
            cell: (info) => /* @__PURE__ */ u("p", {
                class: "whitespace-pre", children: /* @__PURE__ */ u("a", {
                    class: "link", target: "_blank", href: getUserURL(info.row.original), children: [
                        "@",
                        info.getValue()
                    ]
                })
    ...
    const columns = [
        ...
        columnHelper.accessor((row) => getUserScreeNameFromId(row.message_data.sender_id), {
            ...
            cell: (info) => /* @__PURE__ */ u("p", {
                class: "whitespace-pre", children: /* @__PURE__ */ u("a", {
                    class: "link", target: "_blank", href: `https://twitter.com/${info.getValue()}`, children: [
                        "@",
                        info.getValue()
                    ]
                })
        ...
        columnHelper.accessor((row) => getUserScreeNameFromId(row.message_data.recipient_id), {
            ...
            cell: (info) => /* @__PURE__ */ u("p", {
                class: "whitespace-pre", children: info.getValue() ? /* @__PURE__ */ u("a", {
                    class: "link", target: "_blank", href: `https://twitter.com/${info.getValue()}`, children: [
                        "@",
                        info.getValue()
                    ]
    ...
    function Logs({ lines }) {
        ...
        return /* @__PURE__ */ u("pre", {
            class: "leading-none text-xs max-h-48 bg-base-200 overflow-y-scroll m-0 px-1 py-2.5 no-scrollbar rounded-box-half", children: reversed.map((line) => /* @__PURE__ */ u("span", {
                class: colors[line.type], children: [
                    "#",
                    line.index,
                    " ",
                    line.line,
